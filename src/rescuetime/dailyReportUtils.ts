...
import { parseEfficiency, parseOverview, parseActivity } from '../utils/parseUtils'
import { mergeTimeByCategory } from '../utils/misc'
import { getScaledActivityScore } from '../webhook/messageUtils'

import { DailyDataSummaryParams } from '../@types/models'
...
export const getDayilDataSummary = ({ efficiency, overview, activity }: DailyDataSummaryParams) => {
